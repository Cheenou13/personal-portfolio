            ...
            <ul>
                <li>
                    <div class="employer-logo-container">
                        <div class="contents">
                            <div class="h-full w-full opacity-100 overflow-visible relative flex justify-center items-center">
                                <div class="logo-items-container">
                                    <div class="bg-placeholder">
                                        <a href="https://foxconniai.com/" target="_blank">
                                            <div class="svg-container" >
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 374 55">
                                                    <defs>
...
<style scoped>
    ...
    .bg-placeholder {
        opacity: 0.95;
        background-color: rgba(22, 21, 39, 0);
        inset: 0px;
        position: absolute;
    }
    .svg-container {
